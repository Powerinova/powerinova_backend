    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-6 animate-fade-in">
          <img src="/logo.svg" alt="Powerinova" className="h-12 md:h-20 mx-auto" />
        ...
        <div className="bg-white border border-pi-border rounded-3xl p-8 shadow-2xl shadow-teal/5 relative">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-cream/50 border border-pi-border text-teal font-bold py-3.5 rounded-2xl transition-all flex items-center justify-center gap-3 disabled:opacity-50 shadow-sm"
          >
            {googleLoading ? (
              <Loader2 className="w-5 h-5 animate-spin" />
            ) : (
        ...
        <p className="text-center mt-2 text-muted-sage">
          New to the grid?{" "}
